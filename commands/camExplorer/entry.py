...
CMD_ID = f'{config.COMPANY_NAME}_{config.ADDIN_NAME}_cam_explorer'
CMD_NAME = 'CAM Explorer'
CMD_Description = 'Explorer details of the API Object Model'
IS_PROMOTED = True
COMMAND_BESIDE_ID = ''

WORKSPACE_ID = config.manufacture_workspace
TAB_ID = config.manufacture_tab_id
TAB_NAME = config.manufacture_tab_name
...
PALETTE_URL = './commands/camExplorer/resources/html/index.html'
